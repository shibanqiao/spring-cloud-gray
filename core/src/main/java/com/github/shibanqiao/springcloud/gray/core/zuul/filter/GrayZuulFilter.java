package com.github.shibanqiao.springcloud.gray.core.zuul.filter;

import com.github.shibanqiao.springcloud.gray.core.CoreHeaderInterceptor;
...
public class GrayZuulFilter extends ZuulFilter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GrayZuulFilter.class);
